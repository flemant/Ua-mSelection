%% This script estimates the best m given two geometries and velocities. Before using it you must:
...
% Modify line 67 of this script: ubMeas=FuMeas; vbMeas=FvMeas; uErr=FerrMeas;
...
ResultsFileName = "ResultsFile2A.mat";            % Name of the results file to read
